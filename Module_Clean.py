...
class Clean(Clean):
    ...
    def DeleteRedundant_Twitters(self):
        words=['A', 'THE', 'AN', 'TO', 'AND', 'OR', 'NOT','HE','HE','SHE','HIS','HER','THEM','THEY','BACK',
               ...
               'YEARS','LIFE','HIT','\u2026','HTTPSTCOLKVQX4GL82','HTTPSTCORK711SO3PX','HTTPSTCOUCVVSALUVL','HTTPSTCOQABCCXWKUV','3RD','VERY',
               'YES','ASK','OTHERS','SOMETHING','ANYONE','EVERYONE','60M...','SO','BOTH','WANTED','YOURS','GUY','SAME','LOVES','GOING','DOES',
               'HTTPSTCOBUH25IZUO6','THEN','HTTPSTCO5F6SR9G7AQ','TRUE','HTTPSTCOGRSRUCVRGD','HTTPSTCOFK5G3UL1MT','HTTPSTCOXCUFMTL7SG',
               'SINCE','SAID','WHICH','MYSELF','YOURSELF','HISSELF','HERSELF','THEMSELVES','HTTPSTCO6ZZFQ1BBPI','NOPE','ALSO','HTTPSTCOTPATGG2WMR',
               ...
               'DOOR','TRYING','NICE','ALWAYS','USUALLY','SOMETIMES','SELDOM','NEVER','REMEMBER','HTTPSTCOZ3LIVS4KUI','EVERY','GOT','ENOUGH','HIM','HER','HIS',
               ...
               'FUNNY','LEAST','LINK','DAILY','HTTPSTCOZYKCCG4ZHU','WORK','OH','CHILD','DOZEN','EACH','HELPS','FAVOTITE','STORY','IVE','MORNING','WEVE','HTTPS','HOUR',
               'SORRY','EST','ELSE','@DAVIDTAGGART','BUTTON','@JOHNPGAVIN','WENT','THROUGH','ENTRY','@BGURLEY','BIBLE','TOLD','TELL','MEANWHILE','ANYTHING','ANYWHERE',
               'PROBABLY','QUITE','SOURCES','STUDIES','LOVE','CANT','WOW','PAPER','CHOICE','GONNA','TYPE','SISTER','GUYS','FILES','HTTPSTCONVLWJADACI','STATION','EXERCISE',
               'WEEKEND','LOOKING','FULLY','HEARD','BUSY','HAHA','LOTS','RAN','RUN','HOURS','TWEETS','FIND','INSTEAD','AH','ATWELL','WEBSITE','SUMMARY','THUS','SEEM',
               'ADD','GAME','LEAVE','LISTED','HTTPSTCO2SGK5XQIIQ','USES','IDEA','YEAH','AHEAD','APPEARS','WAIT','SPEECH','TH','FINT','HOLDERS','WTF','BA','#2','HES','SIT',
